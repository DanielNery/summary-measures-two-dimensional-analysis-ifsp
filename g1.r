...
function_g1 = function (g1) {
  ...
  b <- hist (g1, breaks=c(0, seq(1, topox, 1)), include.lowest = TRUE, right = FALSE, plot= FALSE)
  ...
  porcent=round((c(b$counts/length(g1))*100), 2)
  print(porcent)
